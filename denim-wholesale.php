...
<head>
    ...
    <meta name="keywords" content="Denim Jeans Wholesale"/>
    ...
    <div class="main">
        <div class="page-details">
            <div class="image-area">
                <img src="../assets/images/jeans-pants/denim-wholesale.jpg" alt="denim wholesale">
            </div>
            <div class="details-area">
                <strong>Style# 13125</strong>
                <ul class="details-list">
                    <li>
                        <strong>Fabric:</strong>
                        <span>98% Cotton 2% Spandex</span>
                    </li>
                    <li>
