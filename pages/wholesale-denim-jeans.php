...
<head>
    ...
    <meta name="keywords" content="Denim Pants Manufacturer"/>
    ...
    <title>Wholesale Denim Jeans</title>
    ...
    <div class="main">
        <div class="page-details">
            <div class="image-area">
                <img src="../assets/images/jeans-pants/wholesale-denim-jeans.jpg" alt="wholesale-denim-jeans">
            </div>
            <div class="details-area">
                <strong>Style# 13133</strong>
                <ul class="details-list">
                    ...
                    <li>
                        ...
                        <span>Light Spray</span>
                    </li>
                    <li>
                        <strong>Colors:</strong>
                        <span>Black, Navy Blue</span>
                    </li>
                    <li>
