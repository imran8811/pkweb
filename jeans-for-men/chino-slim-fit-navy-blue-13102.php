    ...
    <div class="main">
        <div class="page-details">
          <div class="image-area">
            <img src="../assets/images/jeans-for-men/chino-slim-fit-navy-blue-13102.jpg" alt="chino-slim-fit-navy-blue-13102">
          </div>
          <div class="details-area">
            <strong>Article# 13102</strong>
            <ul class="details-list">
              <li>
                <strong>Article Type:</strong>
                <span>Slim Fit Chino Pant</span>
              </li>
              <li>
                <strong>Fabric:</strong>
                <span>98% Cotton 2% Spandex Twill</span>
              </li>
              <li>
            ...
            <div class="btn-back-wrap">
              <a href="https://wa.me/923000911000?text=Style%2313102%0AEnter%20inquiry%20details" class="btn-back">Buy Now</a>
            </div>
          </div>
        </div>
    </div><!-- end of main -->
