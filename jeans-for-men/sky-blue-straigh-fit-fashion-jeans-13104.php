...
<head>
  ...
  <meta name="keywords" content="Jeans Maufacturer, Wholesale Jeans, Jeans Wholesaler"/>
  ...
  <title>Men Denim Black Patched Straight Fit Jeans - 13140</title>
    ...
    <div class="main">
        <div class="page-details">
          <div class="image-area">
            <img src="../assets/images/jeans-for-men/sky-blue-straigh-fit-fashion-jeans-13104.jpg" alt="sky-blue-straigh-fit-fashion-jeans-13104">
          </div>
          <div class="details-area">
            <strong>Article# 13104</strong>
            <ul class="details-list">
              <li>
                <strong>Article Type:</strong>
                <span>Sky Blue Straigh Fit Fashion Jeans</span>
              </li>
              <li>
                <strong>Fabric:</strong>
                <span>98% Cotton 2% Spandex Denim</span>
              </li>
              <li>
              ...
              <li>
                ...
                <span>Enzyme & Silicon Wash</span>
              </li>
              <li>
                <strong>Color:</strong>
                <span>Denim Black</span>
              </li>
              <li>
              ...
              <li>
                ...
                <span>60% Advance <br /> 40% on Shipment</span>
              </li>
            </ul>
            <div class="btn-back-wrap">
              <a href="https://wa.me/923000911000?text=Style%2313104%0AEnter%20inquiry%20details" class="btn-back">Buy Now</a>
            </div>
          </div>
        </div>
    </div><!-- end of main -->
