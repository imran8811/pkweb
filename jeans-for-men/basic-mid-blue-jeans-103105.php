    ...
    <div class="main">
        <div class="page-details">
          <div class="image-area">
            <img src="../assets/images/jeans-for-men/basic-mid-blue-jeans-103105.jpg" alt="basic-mid-blue-jeans-103105">
          </div>
          <div class="details-area">
            <strong>Article# 13105</strong>
            <ul class="details-list">
              <li>
                <strong>Article Type:</strong>
                <span>Basic Mid Blue Jeans</span>
              </li>
              <li>
            ...
            <div class="btn-back-wrap">
              <a href="https://wa.me/923000911000?text=Style%2313105%0AEnter%20inquiry%20details" class="btn-back">Buy Now</a>
            </div>
          </div>
        </div>
    </div><!-- end of main -->
