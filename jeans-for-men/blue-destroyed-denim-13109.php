    ...
    <div class="main">
        <div class="page-details">
          <div class="image-area">
            <img src="../assets/images/jeans-for-men/blue-destroyed-denim-13109.jpg" alt="blue-destroyed-denim-13109">
          </div>
          <div class="details-area">
            <strong>Article# 13109</strong>
            <ul class="details-list">
              <li>
                <strong>Article Type:</strong>
                <span>Blue Destroyed Denim</span>
              </li>
              <li>
