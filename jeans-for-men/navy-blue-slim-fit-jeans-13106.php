    ...
    <div class="main">
        <div class="page-details">
          <div class="image-area">
            <img src="../assets/images/jeans-for-men/navy-blue-slim-fit-jeans-13106.jpg" alt="navy-blue-slim-fit-jeans-13106">
          </div>
          <div class="details-area">
            <strong>Article# 13106</strong>
            <ul class="details-list">
              <li>
                <strong>Article Type:</strong>
                <span>Men Skinny Fit Jeans</span>
              </li>
              <li>
            ...
            <div class="btn-back-wrap">
              <a href="https://wa.me/923000911000?text=Style%2313106%0AEnter%20inquiry%20details" class="btn-back">Buy Now</a>
            </div>
          </div>
        </div>
    </div><!-- end of main -->
