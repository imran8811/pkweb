...
<div class="wrapper">
    ...
    <div class="main-slider">
            ...
            <div>
					...
					<!-- Arrow Navigator -->
					<div data-u="arrowleft" class="jssora051" style="width: 55px; height: 55px; top: 7.15396px; left: 7.15396px; transform: scale(1.26014);" data-autocenter="2" data-scale="0.75" data-scale-left="0.75" data-jssor-button="1" data-nofreeze="1">
						<svg viewBox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
							<polyline class="a" points="11040,1920 4960,8000 11040,14080 "></polyline>
						</svg>
					</div>
					<div data-u="arrowright" class="jssora051" style="width: 55px; height: 55px; top: 7.15396px; right: 25px; left: auto; transform: scale(1.26014);" data-autocenter="2" data-scale="0.75" data-scale-right="0.75" data-jssor-button="1" data-nofreeze="1">
						<svg viewBox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
    ...
    <div class="main-outer">
		...
		<!-- <div class="main-outer">
      <h3 class="section-heading">Our Clients</h3>
      <p>Coming Soon...</p>
		</div> -->
		<div class="main-outer">
    ...
    <div class="main-outer">
      ...
      <div class="faqs-list" itemscope="" itemtype="https://schema.org/FAQPage">
        <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          ...
          <div class="accepted-asnwer" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
        ...
        <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
          ...
          <div class="accepted-asnwer" itemscope itemprop="acceptedAnswer" itemtype="https://schema.org/Answer">
            <div itemprop="text">For custom design order our MOQ is 200 pieces per style per color</div>
          </div>
        </div>
        <div itemscope itemprop="mainEntity" itemtype="https://schema.org/Question">
    ...
    <!-- <div class="main-outer">
			<h3 class="section-heading">Create your own denim brand</h3>
		</div> -->
	</div>
